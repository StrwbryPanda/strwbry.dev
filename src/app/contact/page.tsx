  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="container mx-auto px-6 py-12">
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-24">Contact Me</h1>
        
        <div className="max-w-2xl space-y-8">
          <section className="border border-[#2c2f33] p-8 rounded-lg transition-all duration-300 hover:border-[#ff9af6]">
            <h2 className="text-3xl font-semibold mb-8">Discord</h2>
            ...
            <div>
              <Link 
                ...
                target="_blank"
                className="text-[#ff9af6] hover:text-[#ff9af6] transition-colors relative group"
              >
